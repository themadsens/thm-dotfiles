...
let g:airline#themes#flemming#palette = {}
let g:airline#themes#flemming#palette.accents = {
    \ 'red': ['#d70000', '', 160, '', '']}

let g:airline#themes#flemming#palette.inactive = {
    \ 'airline_a': s:IA,
    \ 'airline_b': s:IA,
    \ 'airline_c': s:IA}

let g:airline#themes#flemming#palette.normal = airline#themes#generate_color_map(s:N1, s:middle, s:N3)
let g:airline#themes#flemming#palette.normal_modified = {
...
let g:airline#themes#flemming#palette.insert = airline#themes#generate_color_map(s:I1, s:middle, s:I3)
let g:airline#themes#flemming#palette.insert_modified = {}

let g:airline#themes#flemming#palette.replace = airline#themes#generate_color_map(s:R1, s:middle, s:R3)
let g:airline#themes#flemming#palette.replace_modified = {}

let g:airline#themes#flemming#palette.visual = airline#themes#generate_color_map(s:V1, s:middle, s:V3)
let g:airline#themes#flemming#palette.visual_modified = {}

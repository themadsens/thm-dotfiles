...
" From: https://github.com/neovim/neovim/tree/ad8adf838c2495b1cd5e95b93aa7ba059e766e63
"
...
func s:StartDebug(bang, ...)
  ...
  call StartDebug_TermDebug({'gdb_args': a:000, 'bang': a:bang})
endfunc

func s:StartDebugCommand(bang, ...)
  " First argument is the command to debug, rest are run arguments.
  call StartDebug_TermDebug({'gdb_args': [a:1], 'proc_args': a:000[1:], 'bang': a:bang})
endfunc

func StartDebug_TermDebug(dict)
  if exists('s:gdbwin')

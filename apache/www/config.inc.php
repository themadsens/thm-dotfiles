<?php
	...
	$conf['servers'][1]['defaultdb'] = 'ocef';

	$conf['servers'][2]['desc'] = 'DEMO sshfwd 5441';
	$conf['servers'][2]['host'] = 'localhost';
	$conf['servers'][2]['port'] = 5441;
	$conf['servers'][2]['sslmode'] = 'allow';
	$conf['servers'][2]['defaultdb'] = 'staging0';

	$conf['servers'][3]['desc'] = 'CheckMark sshfwd 5449 (occheckmark:qweasdzxc)';
	$conf['servers'][3]['host'] = 'localhost';
	$conf['servers'][3]['port'] = 5449;
	$conf['servers'][3]['sslmode'] = 'allow';
	$conf['servers'][3]['defaultdb'] = 'occheckmark';

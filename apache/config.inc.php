<?php
	...
	$conf['servers'][0]['defaultdb'] = 'ampep';
	...
	$conf['servers'][1]['desc'] = 'UE Thinkpad';
	$conf['servers'][1]['host'] = 'localhost';
	$conf['servers'][1]['port'] = 54321;
	$conf['servers'][1]['sslmode'] = 'allow';
	$conf['servers'][1]['defaultdb'] = 'opencity';

	$conf['servers'][2]['desc'] = 'GL Test';
	$conf['servers'][2]['host'] = 'testpg32';
	$conf['servers'][2]['port'] = 5432;
	$conf['servers'][2]['sslmode'] = 'allow';
	$conf['servers'][2]['defaultdb'] = 'test_opencity';

	$conf['servers'][3]['desc'] = 'GL Test GR';
	$conf['servers'][3]['host'] = 'testpg32';
	$conf['servers'][3]['port'] = 5432;
	$conf['servers'][3]['sslmode'] = 'allow';
	$conf['servers'][3]['defaultdb'] = 'test_greenwise';

	$conf['servers'][4]['desc'] = 'DEMO sshfwd 5441';
	$conf['servers'][4]['host'] = 'localhost';
	$conf['servers'][4]['port'] = 5441;
	$conf['servers'][4]['sslmode'] = 'allow';
	$conf['servers'][4]['defaultdb'] = 'staging0';

	$conf['servers'][5]['desc'] = 'CheckMark sshfwd 5449 (occheckmark:qweasdzxc)';
	$conf['servers'][5]['host'] = 'localhost';
	$conf['servers'][5]['port'] = 5449;
	$conf['servers'][5]['sslmode'] = 'allow';
	$conf['servers'][5]['defaultdb'] = 'occheckmark';

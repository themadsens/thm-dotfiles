...
set -wg pane-border-format " #{?window_zoomed_flag, #[fg=colour31]#[fg=black]#[bg=colour31][ZOOMED:#{pane_index}/#{window_panes}]#[default]#[fg=colour31]#[default], }#[fg=colour#{?pane_active,31,242}]#[fg=black,bg=colour#{?pane_active,31,242}]-- #{pane_index} #[fg=colour#{?pane_active,244,238}]#[fg=black]#[bg=colour#{?pane_active,244,238}]#{pane_title}#[default]#[fg=colour#{?pane_active,244,238}] "
